 ...
 */
public class AdaptadorRecomendaciones extends RecyclerView.Adapter<AdaptadorRecomendaciones.RevistaViewHolder>{

    private List<Revista> listaRevistas;
    private DesgloseRevista desglose;
    ...
    public class RevistaViewHolder extends RecyclerView.ViewHolder {
        ...
        public RevistaViewHolder(View v) {
            super(v);
            portada = (ImageView) v.findViewById(R.id.small_portada2);
            titulo_lista = (TextView) v.findViewById(R.id.title_list2);
        }
    }

    public AdaptadorRecomendaciones(DesgloseRevista desglose, List<Revista> listaRevistas){
    ...
    public RevistaViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_revista, parent, false);
    ...
    public void onBindViewHolder(RevistaViewHolder holder, int position) {
        ...
        Glide.with(desglose).load(listaRevistas.get(position).getPortada()).into(holder.portada);
    }
