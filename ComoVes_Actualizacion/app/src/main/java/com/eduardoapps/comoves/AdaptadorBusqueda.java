 ...
 */
public class AdaptadorBusqueda extends RecyclerView.Adapter<AdaptadorBusqueda.RevistaViewHolder>{
    ...
    public AdaptadorBusqueda(Buscar buscar, List<Revista> listaRevistas){
        this.buscar = buscar;
    ...
    public void onBindViewHolder(RevistaViewHolder holder, int position) {
        ...
        Glide.with(buscar).load(listaRevistas.get(position).getPortada()).into(holder.portada);
    }
